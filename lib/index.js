...
function gitUrlParse(url) {
    ...
    switch (urlInfo.source) {
        ...
        case "visualstudio.com":
            ...
            if (splits.length === 2) {
                ...
                urlInfo.organization = (splits[0] === 'DefaultCollection') ? splits[0] : ''
                urlInfo.name = splits[2]

                urlInfo.full_name = (urlInfo.organization === '') ? urlInfo.owner + '/' : urlInfo.organization + '/'
            } else if (splits.length === 4) {
                urlInfo.organization = splits[0]
                urlInfo.owner = splits[1]
                urlInfo.name = splits[3]
                urlInfo.full_name = urlInfo.organization + '/' + urlInfo.owner + '/'
            }
    ...
    if (!urlInfo.full_name) {
        ...
        if (urlInfo.name) {
            ...
            (urlInfo.source === 'visualstudio.com') ? urlInfo.full_name += '_git/' + urlInfo.name : urlInfo.full_name += urlInfo.name;
        }
    }
