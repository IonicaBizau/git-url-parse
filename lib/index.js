...
function gitUrlParse(url) {
    ...
    switch (urlInfo.source) {
        ...
        case "visualstudio.com":
            // Note: Use decodeURIComponent since VSTS repository and project names may contain whitespace characters
            splits = urlInfo.name.split("/");
            if (splits.length === 2) {
                urlInfo.owner = decodeURIComponent(splits[1]);
                urlInfo.name = decodeURIComponent(splits[1]);
            } else if (splits.length > 2) {
                urlInfo.owner = decodeURIComponent(splits[0]);
                urlInfo.name = decodeURIComponent(splits[2]);
            }
